...
USE_VENDOR_APT=0
MAIXCAM_SENSOR_CONFIG=
MAIXCAM_SENSOR_FIXED=0
MAIXCAM_SENSOR_PQ=sipeed_gc4653_30fps_202403261356.bin

LINUX_COMMIT=$(MAIXCAM_LINUX_COMMIT)
FSBL_COMMIT=$(MAIXCAM_FSBL_COMMIT)
