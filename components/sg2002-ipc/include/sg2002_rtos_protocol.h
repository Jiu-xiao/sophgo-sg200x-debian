...
enum sg2002_rtos_command {
	...
	SG2002_RTOS_CMD_ECHO,
};

#define SG2002_RTOS_PING_XOR 0xa5a55a5aU

/* Shared-memory messages carry the application command in payload byte 0. */
#define SG2002_RTOS_VALUE_MESSAGE_SIZE 5U
#define SG2002_RTOS_VALUE_MESSAGE_COMMAND_OFFSET 0U
#define SG2002_RTOS_VALUE_MESSAGE_VALUE_OFFSET 1U
...
#define SG2002_RTOS_CAP_ECHO (1U << 1)
#define SG2002_RTOS_CAPABILITIES \
	(SG2002_RTOS_CAP_GPIO | SG2002_RTOS_CAP_ECHO)
